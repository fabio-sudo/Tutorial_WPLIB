...
public final class CalibrationCommands {
    ...
    // #region TESTE KS REVERSO DO DRIVE

// ============================================================
// TESTE EXPERIMENTAL DE kS - SENTIDO REVERSO
// ============================================================
//
// OBJETIVO:
//
// Fazer exatamente o mesmo teste de kS,
// porém aplicando tensão NEGATIVA.
//
// Sequência:
//
//  0.00 V
...
public static Command driveKsReverseTest(
    Drive drive
) {
